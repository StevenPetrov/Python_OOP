from EXAM_PREP_1.controller import Controller
from EXAM_PREP_1.player import Player
from EXAM_PREP_1.supply.drink import Drink
from EXAM_PREP_1.supply.food import Food
